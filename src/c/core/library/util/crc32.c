...
// define crc-32 private constants

#define CRC_TABLE_SIZE									256

const unsigned long CRC_TABLE[CRC_TABLE_SIZE] = {
...
// define crc-32 public functions
...
unsigned int crc32_calculateHash(char *value, int valueLength)
{
	...
	while(valueLength) {
		crc = ((crc >> 8) ^ (unsigned long)CRC_TABLE[(crc & 0xff) ^ *ptr]);
		ptr++;
		valueLength--;
	}
